const translations = {
    ru: {
        ...
        svc_exchange_title: 'Обменник / Вывод',
        svc_exchange_sub: 'Продай ⭐️, TON и USDT',
        ...
        // New Rent stuff
        rent_all_collections: 'Все коллекции',
        rent_all_models: 'Все модели',
        rent_best_deals: 'Лучшие предложения',
        rent_show_best_deals: '🔥 Смотреть лучшие предложения',
        rent_back_to_regular: '← Назад к обычным предложениям',
        rent_modal_title: 'Аренда NFT',
        rent_open_in_telegram: '🔗 Открыть в Telegram',
        rent_label_duration: 'Срок аренды (от {min} до {max} дней)',
        rent_label_pay_method: 'Способ оплаты',
        rent_pay_internal: 'Оплатить со счета',
        rent_pay_stars: 'Звёзды (Telegram)',
        rent_btn_pay: 'Оплатить аренду',
        rent_error_duration: 'Укажите от {min} до {max} дней',
        rent_gas_fee: 'Комиссия сети (Gas):',
        rent_total: 'Итого:',
        rent_price: 'Аренда:',
        rent_success_title: 'Аренда оформлена!',
        rent_success_msg_stars: 'Вы успешно оплатили аренду на {days} дн. звёздами.',
        rent_success_msg_ton: 'Вы успешно арендовали NFT на {days} дн.',
        rent_success_hint: 'Нажмите «Закрыть», чтобы перейти к установке NFT.',
        rent_install_title: 'Установка NFT',
        rent_install_placeholder: 'tc://...',
        rent_install_btn: 'Подключить',
        rent_install_success: 'Успешно!',
        rent_install_success_msg: 'Кошелёк подключён. NFT скоро обновит статус в профиле.',
        rent_instruction_btn: 'Инструкция',
        rent_loading: '⏳ Загрузка...',
        rent_loading_more: 'Загружаем...',
        rent_empty: 'Нет предложений',
        rent_error: 'Ошибка загрузки',
    },
    en: {
        // Navigation
        nav_home: 'Home',
        ...
        svc_exchange_title: 'Exchange / Withdrawal',
        svc_exchange_sub: 'Sell ⭐️, TON and USDT',
        ...
        // New Rent stuff
        rent_all_collections: 'All Collections',
        rent_all_models: 'All Models',
        rent_best_deals: 'Best Offers',
        rent_show_best_deals: '🔥 View Best Offers',
        rent_back_to_regular: '← Back to Regular Offers',
        rent_modal_title: 'NFT Rental',
        rent_open_in_telegram: '🔗 Open in Telegram',
        rent_label_duration: 'Rental period ({min} to {max} days)',
        rent_label_pay_method: 'Payment method',
        rent_pay_internal: 'Pay from balance',
        rent_pay_stars: 'Stars (Telegram)',
        rent_btn_pay: 'Pay for rental',
        rent_error_duration: 'Specify from {min} to {max} days',
        rent_gas_fee: 'Network Fee (Gas):',
        rent_total: 'Total:',
        rent_price: 'Rental:',
        rent_success_title: 'Rental completed!',
        rent_success_msg_stars: 'You have successfully paid for rental for {days} days with stars.',
        rent_success_msg_ton: 'You have successfully rented the NFT for {days} days.',
        rent_success_hint: 'Click "Close" to proceed with NFT installation.',
        rent_install_title: 'NFT Installation',
        rent_install_placeholder: 'tc://...',
        rent_install_btn: 'Connect',
        rent_install_success: 'Success!',
        rent_install_success_msg: 'Wallet connected. NFT status will update in your profile soon.',
        rent_instruction_btn: 'Instructions',
        rent_loading: '⏳ Loading...',
        rent_loading_more: 'Loading...',
        rent_empty: 'No offers',
        rent_error: 'Load error',
    }
};
